defmodule JidoSystem.Agents.FoundationAgentTest do
    ...
    test "successfully initializes and registers with Foundation", %{registry: registry} do
      ...
      case Foundation.Registry.lookup(global_registry, pid) do
        {:ok, {^pid, metadata}} ->
          ...
          assert metadata.capability == [:general_purpose]  # Note: singular "capability" 
  ...
  describe "helper functions" do
    ...
    test "coordinate_with_agents helper initiates coordination", %{agent: agent, agent_state: agent_state} do
