defmodule Foundation.OTPCleanupIntegrationTest do
    ...
    test "no unguarded Process.put/get usage in production code" do
      ...
      unguarded_violations =
        Enum.flat_map(lib_files, fn file ->
          ...
          unguarded =
            Enum.filter(process_dict_lines, fn {line, line_num} ->
      ...
      allowed_files = [
        ...
        "lib/foundation/credo_checks/no_process_dict.ex",
        # Legacy implementations
        "lib/foundation/telemetry/legacy",
        # Legacy implementations  
        "lib/foundation/protocols/legacy",
      ...
      unexpected_violations =
        Enum.reject(unguarded_violations, fn {file, _} ->
  ...
  describe "Error Context Migration Tests" do
    ...
    test "with_context provides isolation" do
      ...
      result =
        ErrorContext.with_context(%{operation: "test"}, fn ->
          context = ErrorContext.get_context()
  ...
  describe "Telemetry Migration Tests" do
    ...
    test "span with_span helper works correctly" do
      result =
        Span.with_span_fun("test_operation", %{operation: "test"}, fn ->
          # Simulate work
          "operation_result"
        end)
  ...
  describe "System Integration Tests" do
    ...
    test "telemetry events are still emitted correctly" do
      ...
      assert_receive {:collected_event, [:foundation, :registry, :register], _measurements,
                      _metadata},
                     1000
    ...
    test "handles concurrent flag changes during operations" do
      ...
      Enum.each(operation_results, fn result ->
        case result do
          {:ok, _} -> :ok
          {:error, _} -> :ok
          # Handle Registry.lookup returning :error
          :error -> :ok
          # Handle Registry.register returning :ok
          :ok -> :ok
