defmodule Foundation.OTPCleanupFailureRecoveryTest do
  ...
  @moduletag timeout: 180_000  # 3 minutes for failure recovery tests
  ...
  describe "ETS Table Failure Recovery" do
    ...
    test "multiple ETS table failures" do
      ...
      services_started = case Code.ensure_loaded?(Foundation.Protocols.RegistryETS) do
        {:module, _} ->
      ...
      services_started = case Code.ensure_loaded?(Foundation.Telemetry.SampledEvents) do
        {:module, _} ->
      ...
      ets_tables = :ets.all()
      foundation_tables = Enum.filter(ets_tables, fn table ->
      ...
      case Code.ensure_loaded?(Foundation.Telemetry.SampledEvents) do
        {:module, _} ->
          ...
          try do
            ...
            _ -> :ok  # Expected if service is down
          end
  ...
  describe "Network and External Failure Simulation" do
    ...
    test "graceful degradation under extreme failure" do
      ...
      try do
        ...
        _ -> :ok  # Expected in degraded mode
      end
