defmodule Foundation.MABEAM.AgentSupervisorTest do
  @moduledoc """
  Tests for Foundation.MABEAM.AgentSupervisor.
  ...
  alias Foundation.MABEAM.{Agent, AgentSupervisor}
  ...
  describe "agent supervision" do
    test "starts and supervises agents dynamically" do
      ...
      children = DynamicSupervisor.which_children(Foundation.MABEAM.AgentSupervisor)
  ...
  describe "error handling and recovery" do
    test "handles supervisor crashes gracefully" do
      ...
      # Get supervisor PID
      supervisor_pid = Process.whereis(Foundation.MABEAM.AgentSupervisor)
    ...
    try do
      ...
      Enum.each(children, fn {_, pid, _, _} ->
        if is_pid(pid) and Process.alive?(pid) do
          DynamicSupervisor.terminate_child(Foundation.MABEAM.AgentSupervisor, pid)
        end
      end)
