defmodule Foundation.MABEAM.Integration.SimpleStressTest do
  use ExUnit.Case, async: false

  alias Foundation.MABEAM.{AgentRegistry, Core}
        ...
        for i <- 1..agent_count do
          Task.async(fn ->
            ...
            config = %{
              id: agent_id,
              type: :worker,
              module: Foundation.MABEAM.SimpleStressAgent,
              config: %{agent_id: i},
...
defmodule Foundation.MABEAM.SimpleStressAgent do
  use GenServer
