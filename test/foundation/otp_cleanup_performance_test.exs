defmodule Foundation.OTPCleanupPerformanceTest do
  ...
  # 1ms per operation
  @registry_operation_threshold 1000
  # 0.1ms per operation  
  @error_context_threshold 100
  # 0.5ms per operation
  @span_operation_threshold 500
  ...
  describe "Registry Performance Tests" do
    ...
    test "concurrent registry access performance" do
      ...
      if Code.ensure_loaded?(Foundation.Protocols.RegistryETS) do
        ...
        # register + lookup
        total_operations = num_processes * operations_per_process * 2
  ...
  describe "Telemetry Performance Tests" do
    ...
    test "with_span performance" do
      ...
      # Allow 2x for convenience wrapper
      assert avg_with_span < @span_operation_threshold * 2,
             """
  ...
  describe "Performance Comparison Matrix" do
    test "performance matrix for all implementations" do
      ...
      test_cases = [
        ...
        %{
          name: "all_new",
          flags: [:use_ets_agent_registry, :use_logger_error_context, :use_genserver_telemetry]
        }
      ]
