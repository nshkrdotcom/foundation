defmodule MABEAM.Core do
  ...
  alias MABEAM.{Coordination, ProcessRegistry}
  ...
  @spec delete_variable(atom(), MABEAM.Types.agent_id()) :: :ok | {:error, term()}
