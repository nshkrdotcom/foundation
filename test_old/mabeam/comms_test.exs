defmodule MABEAM.CommsTest do
  use ExUnit.Case, async: false

  alias MABEAM.{Comms, ProcessRegistry, Types}
  ...
  setup do
    ...
    agent_configs = [
      ...
      Types.new_agent_config(:slow_responder, SlowTestResponder, [delay: 500],
        capabilities: [:responds]
      ),
      Types.new_agent_config(:failing_responder, FailingTestResponder, [],
        capabilities: [:responds]
      ),
  ...
  describe "telemetry and monitoring" do
    test "emits telemetry events for requests", %{agents: agents} do
      ...
      assert_receive {:telemetry_event, [:foundation, :mabeam, :comms, :request], measurements,
                      metadata}
  ...
  describe "distributed communication preparation" do
    test "message serialization compatibility" do
      ...
      test_messages = [
        ...
        {:coordination_request,
         Types.new_coordination_request(
           :consensus,
           :voting,
    ...
    test "node-agnostic agent addressing", %{agents: agents} do
      ...
      result =
        case Comms.request(responder_id, {:echo, "node_test"}) do
