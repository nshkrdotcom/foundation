defmodule Foundation.Error do
  ...
  Based on lib_old patterns with hierarchical error code system (C000-C999, S000-S999, etc.),
  enhanced error context and recovery strategies, standardized error propagation patterns,
  and error metrics and analysis capabilities.
