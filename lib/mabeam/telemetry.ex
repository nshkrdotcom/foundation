defmodule MABEAM.Telemetry do
  ...
  ## Usage
      ...
      :ok = MABEAM.Telemetry.record_agent_metric(:my_agent, :response_time, 150)

      # Track coordination events
      :ok = MABEAM.Telemetry.record_coordination_metric(:consensus_protocol, :success_rate, 0.95)

      # Get agent analytics
      {:ok, metrics} = MABEAM.Telemetry.get_agent_metrics(:my_agent, :last_hour)

      # Monitor system health
      {:ok, health} = MABEAM.Telemetry.get_system_health()
  """
