defmodule Foundation.Telemetry.SampledEvents do
  ...
  defdelegate emit_event_test(event_name, measurements, metadata),
    to: Foundation.Telemetry.SampledEvents.TestAPI,
    as: :emit_event

  defdelegate emit_batched_test(event_name, measurement, metadata),
    to: Foundation.Telemetry.SampledEvents.TestAPI,
    as: :emit_batched
